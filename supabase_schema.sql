...
-- Create table for mission photos
...
-- Policies for mission_photos
CREATE POLICY "Allow PUBLIC SELECT on mission_photos" ON public.mission_photos FOR SELECT USING (true);
CREATE POLICY "Allow PUBLIC INSERT on mission_photos" ON public.mission_photos FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow PUBLIC DELETE on mission_photos" ON public.mission_photos FOR DELETE USING (true);

-- Grant permissions for mission_photos
