...
* [ ] **🔴 Mode PWA / Offline-first.** Rendre l'app installable et fonctionnelle sans réseau (lieux d'événement mal couverts). Cache des missions du jour + file de synchro des pointages QR différés. *La fonctionnalité la plus demandée par le terrain.*
