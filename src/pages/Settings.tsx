...
import { Save, User, Lock, ArrowLeft, Calendar, Settings as SettingsIcon, LogOut } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#e2e8f0] overflow-hidden">
          <div className="p-4 sm:p-6 border-b border-[#e2e8f0]">
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-4 max-w-xl">
              <div>
                <label htmlFor="settings-email" className="block text-xs font-bold text-[#64748b] uppercase tracking-wider mb-2">Email</label>
                <input
                  id="settings-email"
                  type="email"
                  disabled
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="settings-firstname" className="block text-xs font-bold text-[#64748b] uppercase tracking-wider mb-2">Prénom</label>
                  <input
                ...
                <div>
                  <label htmlFor="settings-lastname" className="block text-xs font-bold text-[#64748b] uppercase tracking-wider mb-2">Nom</label>
                  <input
        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#e2e8f0] overflow-hidden">
          <div className="p-4 sm:p-6">
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4 max-w-xl">
              <div>
                <label htmlFor="settings-newpassword" className="block text-xs font-bold text-[#64748b] uppercase tracking-wider mb-2">Nouveau mot de passe</label>
                <input
              ...
              <div>
                <label htmlFor="settings-confirmpassword" className="block text-xs font-bold text-[#64748b] uppercase tracking-wider mb-2">Confirmer le mot de passe</label>
                <input
